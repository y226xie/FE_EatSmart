...
import {Button, View, Text, StyleSheet, ScrollView, Dimensions, SafeAreaView} from 'react-native';
  ...
  render() {
    ...
    return (
      <SafeAreaView style={{flex: 1}}>
        ...
        <SearchFilterView data={cuisines} selectedItems={this.state.cuisinesFilter} pushItem={this.addCuisines} popItem={this.removeCuisines}/>
        <SearchFilterView data={diets} selectedItems={this.state.dietsFilter} pushItem={this.addDiets} popItem={this.removeDiets}/>
